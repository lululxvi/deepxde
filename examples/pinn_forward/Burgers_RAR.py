...
err = 1
iterations = 0
while err > 0.005 and iterations < get_number_of_steps(10000):
    ...
    model.train(epochs=get_number_of_steps(10000), disregard_previous_best=True, callbacks=[early_stopping])
    model.compile("L-BFGS")
