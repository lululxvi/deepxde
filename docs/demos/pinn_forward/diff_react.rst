...
We will solve the following 1D reaction-diffusion equation:
...
This description goes through the implementation of a solver for the above described reaction-diffusion equation step-by-step.
...
Next, we express the PDE residual of the reaction-diffusion equation:
