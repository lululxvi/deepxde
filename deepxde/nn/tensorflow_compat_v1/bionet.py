...
class BiONetCartesianProd(NN):
    """Deep operator network with two input functions for dataset in the format of Cartesian product."""
    ...
    def __init__(
        ...
        super(BiONetCartesianProd, self).__init__()
